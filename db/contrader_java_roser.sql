...
DROP TABLE IF EXISTS `werable_devices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `werable_devices` (
  `wear_id` int(11) NOT NULL AUTO_INCREMENT,
  `wear_type` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `wear_val` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `wear_date` datetime COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`wear_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treatment_plan` (
  ...
  `plan_surname` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `payment` (
  ...
  `pay_card_number` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
  `pay_owner_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
    `pay_owner_surname` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
      `pay_owner_cvv` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  `pay_exp` datetime COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`pay_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
