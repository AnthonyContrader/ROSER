...
public class RobotDTO {
	...
	public RobotDTO(int robotId, String robotModel, String robotUsername, String robotPassword, String ownerName,
			String ownerSurname) {
	...
	{
		return this.getRobot_model() + "\t" + this.getRobot_username() + "\t" + this.getRobot_password() + "\t" + this.getRobot_owner_name() +"\t" +this.getRobot_owner_surname();
	}
