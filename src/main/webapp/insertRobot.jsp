  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Insert Robot</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i>Home</a></li>
              <li><i class="fa fa-laptop"></i>Inser Robot</li>
            </ol>
          </div>
        </div>
	...
	<br>
	<a class="btn btn-primary btn-lg btn-block" href="/Admin/devicesManagement">Back</a>
            </div>
        </div>
