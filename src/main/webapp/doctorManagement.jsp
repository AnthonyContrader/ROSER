        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<table class="table table-striped">
					<tr><th>UserId</th><th>Name</th><th>Surname</th><th>Username</th><th>Password</th><th>Type</th><th>State</th><th colspan=2>Option</th></tr>
						<%
		 			...
		 			<tr>
		 				...
		 				<td><a class="btn btn-primary btn-lg btn-block" href="/Admin/deleteDoctor?id=<%=user.getUserId() %>">Delete</a></td>
		 				<td><a class="btn btn-primary btn-lg btn-block" href="/Admin/redirectUpdate?id=<%=user.getUserId()%>">Update</a></td>
		 			</tr>
						<% 
							}
						%>
				</table>
				<a class="btn btn-primary btn-lg btn-block" href="/insertDoctor.jsp/">Insert Doctor</a>
				<br>
				<br>
