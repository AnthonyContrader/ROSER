		...
		<%
		 ...
		 %>
		 	<tr>
		 		...
		 		<td><a class="btn btn-primary btn-lg btn-block" href="/Doctor/deleteUser?id=<%=user.getUserId() %>">Delete</a></td>
		 		<td><a class="btn btn-primary btn-lg btn-block"href="/Doctor/redirectUpdate?id=<%=user.getUserId()%>">Update</a></td>
		 	</tr>
		<% 
			}
		%>
	</table>
	<a class="btn btn-primary btn-lg btn-block" href="/insertUser.jsp/">Insert Patient</a>
	<br>
